...
define('DB_NAME', 'pokedex'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'pokedex'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
